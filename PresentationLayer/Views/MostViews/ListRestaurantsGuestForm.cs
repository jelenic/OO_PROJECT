...
{
    public partial class ListRestaurantsGuestForm : Form
    {
        private List<RestaurantModel> restaurantList;
        public ListRestaurantsGuestForm()
        {
            InitializeComponent();
        ...
        private RestaurantItemGuest CreateRestaurantItem(RestaurantModel rm)
        {
            RestaurantItemGuest item = new RestaurantItemGuest(rm, this);
